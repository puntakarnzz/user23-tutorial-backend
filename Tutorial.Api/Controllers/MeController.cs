    ...
    public class MeController : ControllerBase
    {
        ...
        public async Task<ContentResult> Message(){
            return new ContentResult{
                ...
                Content = await HttpRequestAsync("https://raw.githubusercontent.com/puntakarnzz/puntakarnzz.github.io/main/index.html") + " <b>Dotnet Tutorial Backend v1.1.0 edit</b>"
            };
        }   
